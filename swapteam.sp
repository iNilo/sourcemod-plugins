...
public Action Command_Swapteam(int client, int args)
{
    ...
    if (tn_is_ml)
	{
		Core_ShowActivity2(client, "[SWAPTEAM] ", "Swapped %t to the opposite team!", target_name);
	}
	else
	{
		Core_ShowActivity2(client, "[SWAPTEAM] ", "Swapped %s to the opposite team!", target_name);
	}
...
public Action Command_Swapteam_Round_Prestart(int client, int args)
{
    ...
    if (tn_is_ml)
	{
		Core_ShowActivity2(client, "[RESPAWN] ", "%t will be switched to the opposite team on round end!", target_name);
	}
	else
	{
		Core_ShowActivity2(client, "[RESPAWN] ", "%s will be switched to the opposite team on round end!", target_name);
	}
...
public Action Command_Swapteam_Death(int client, int args)
{
    ...
    if (tn_is_ml)
	{
		Core_ShowActivity2(client, "[SWAPTEAM] ", "Toggled swapteam on death for %t!", target_name);
	}
	else
	{
		Core_ShowActivity2(client, "[SWAPTEAM] ", "Toggled swapteam on death for %s!", target_name);
	}
...
public Action Command_Team(int client, int args)
{
    ...
    if (tn_is_ml)
	{
		Core_ShowActivity2(client, "[SWAPTEAM] ", "Changed team of %t!", target_name);
	}
	else
	{
		Core_ShowActivity2(client, "[SWAPTEAM] ", "Changed team of %s!", target_name);
	}
